...
public class Hybris123Tests {
	...
	public void testAcceleratorQuickDiveIsOk() throws Exception {
		...
		navigateTo("https://powertools.localhost:9002/yb2bacceleratorstorefront/powertools/en/USD/login");
	...
	public void testDynamicAttributeView() throws Exception {
		canLoginToHybrisCommerce();
		navigateTo("https://powertools.localhost:9002/concerttours/bands/A001");
		waitFor("a","The Grand Little x Tour");
		navigateTo("https://powertools.localhost:9002/concerttours/tours/201701");
	...
	public void testBandImages() throws Exception {
		canLoginToHybrisCommerce();
		navigateTo("https://powertools.localhost:9002/concerttours/bands");
		waitForValidImage();
		navigateTo("https://powertools.localhost:9002/concerttours/bands/A006");
	...
	public void testWebAppComponent() throws Exception {
		...
		navigateTo("https://powertools.localhost:9002/concerttours/bands");
		waitFor("a","The Quiet");
		navigateTo("https://powertools.localhost:9002/concerttours/bands/A007");
	...
	public void simulateGroovyScript() throws Exception {
		...
		canLoginToHybrisCommerce();
		navigateTo("https://powertools.localhost:9002/console/scripting");
